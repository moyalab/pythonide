# -*- coding: utf-8 -*-
"""PoseClassifier — load a .fcm pose-keypoint model and classify webcam frames.

Independent of PoseDetector: keypoints are extracted on the JS side using
exactly the same library and options that the training panel used
(@mediapipe/tasks-vision PoseLandmarker), so training and inference share
...
class PoseClassifier:
    """Pose keypoint classifier loaded from a .fcm file.
